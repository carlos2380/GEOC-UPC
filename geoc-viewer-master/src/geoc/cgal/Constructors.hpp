...
class Viewer_Point_2_cons {
	...
	Rep operator()(CGAL::Return_base_tag, CGAL::Origin o) const { return Rep(o); }

	Rep operator()(CGAL::Return_base_tag, const RT& x, const RT& y) const { return Rep(x, y); }

	Point_2 operator()(CGAL::Origin o) const { return Vector2(0, 0, 0); }

	Point_2 operator()(const RT& x, const RT& y) const { return Vector2(x, y); }
};
...
class Viewer_Point_3_cons {
	...
	Point_3 operator()(CGAL::Origin o) const { return Vector3(0, 0, 0); }

	Point_3 operator()(const RT& x, const RT& y, const RT& z) const { return Vector3(x, y, z); }
};
